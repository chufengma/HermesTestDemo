...
public class ReactViewBackgroundDrawable extends Drawable {
  ...
  public void draw(Canvas canvas) {
    ...
    } else if ((!YogaConstants.isUndefined(mBorderRadius) && mBorderRadius > 0)
            && mBorderStyle != null && mBorderStyle != BorderStyle.SOLID) {
      drawRoundedBackgroundWithBorders2(canvas);
    } else {
  ...
  private void drawRoundedBackgroundWithBorders2(Canvas canvas) {
    ...
    if (borderLeft > 0 && borderRight > 0 && borderTop > 0 && borderBottom > 0) {
      ...
      mPaint.setStrokeWidth((float) (borderLeft + 0.5));

      if (borderLeft > 0) {

        path.moveTo(left + borderLeft / 2, bottom - mBorderRadius);
        path.quadTo(left + borderLeft / 2, bottom - mBorderRadius, left + borderLeft / 2, top + mBorderRadius);

        RectF oval = new RectF(left + borderLeft / 2, top + borderLeft / 2, left + 2 * mBorderRadius - borderLeft / 2, top + 2 * mBorderRadius - borderLeft / 2);
      ...
      if (borderTop > 0) {
        ...
        path.quadTo(left + mBorderRadius, top + borderTop / 2, right - mBorderRadius, top + borderTop / 2);


        RectF oval = new RectF(right - 2 * mBorderRadius + borderTop / 2, top + borderTop / 2, right - borderTop / 2, top + 2 * mBorderRadius - borderTop / 2);
        path.arcTo(oval, -90, 90);
      }

      if (borderRight > 0) {
        path.quadTo(right - borderRight / 2, top + mBorderRadius, right - borderRight / 2, bottom - mBorderRadius);

        RectF oval = new RectF(right - 2 * mBorderRadius + borderTop / 2, bottom - 2 * mBorderRadius + borderTop / 2, right - borderTop / 2, bottom - borderTop / 2);
        path.arcTo(oval, 0, 90);
      }

      if (borderBottom > 0) {
        path.quadTo( right - mBorderRadius, bottom - borderBottom / 2, left + mBorderRadius, bottom - borderBottom / 2);
        RectF oval = new RectF(left + borderTop / 2, bottom - 2 * mBorderRadius + borderTop / 2, left + 2 * mBorderRadius - borderTop / 2, bottom - borderTop / 2);
        path.arcTo(oval, 90, 90);
      }
        ...
        if (Color.alpha(fastBorderColor) != 0) {
          ...
          if (borderLeft > 0) {
            ...
            if (mBorderStyle != null) {
              mPaint.setPathEffect(mBorderStyle.getPathEffect(mBorderStyle, borderLeft));
            }
            if (needMove) {
              path.moveTo(left + borderLeft / 2, bottom);
            }

            path.quadTo(left + borderLeft / 2, bottom, left + borderLeft / 2, top + borderLeft / 2);
//            canvas.drawLine(left + borderLeft / 2, top, left + borderLeft / 2, bottom, mPaint);
            needMove = false;
          } else {
            needMove = true;
          }
          if (borderTop > 0) {
            ...
            mPaint.setStyle(Paint.Style.STROKE);
            mPaint.setStrokeWidth((float) (borderTop + 0.5));
            if (needMove) {
              path.moveTo(left, top + borderTop / 2);
            }
            if (mBorderStyle != null) {
              mPaint.setPathEffect(mBorderStyle.getPathEffect(mBorderStyle, borderTop));
            }
            path.quadTo(left, top + borderTop / 2 , right - borderRight / 2, top + borderTop / 2);
            needMove = false;
//            canvas.drawRect(left + borderLeft, top, right, topInset, mPaint);
//            canvas.drawLine(left, top + borderTop / 2, right, top + borderTop / 2, mPaint);
          } else {
            needMove = true;
          }
          if (borderRight > 0) {
            ...
            mPaint.setStyle(Paint.Style.STROKE);
            mPaint.setStrokeWidth((float) (borderRight + 0.5));
            if (needMove) {
              path.moveTo(right - borderRight / 2 , top);
            }
            if (mBorderStyle != null) {
              mPaint.setPathEffect(mBorderStyle.getPathEffect(mBorderStyle, borderRight));
            }
            path.quadTo(right - borderRight / 2 , top, right - borderRight / 2, bottom - borderBottom / 2);
            needMove = false;
//            canvas.drawRect(rightInset, top + borderTop, right, bottom, mPaint);
//            canvas.drawLine(rightInset + borderRight / 2, top, rightInset + borderRight / 2, bottom, mPaint);
          } else {
            needMove = true;
          }
          if (borderBottom > 0) {
            ...
            mPaint.setStyle(Paint.Style.STROKE);
            mPaint.setStrokeWidth((float) (borderBottom + 0.5));
            if (needMove) {
              path.moveTo(right - borderRight / 2, bottom - borderBottom / 2);
            }
            if (mBorderStyle != null) {
              mPaint.setPathEffect(mBorderStyle.getPathEffect(mBorderStyle, borderBottom));
            }
            path.quadTo(right - borderRight / 2, bottom - borderBottom / 2, left, bottom - borderBottom / 2);
//            canvas.drawRect(left, bottomInset, right - borderRight, bottom, mPaint);
//            canvas.drawLine(left, bottomInset + borderBottom / 2, right, bottomInset + borderBottom / 2, mPaint);
          }
          canvas.drawPath(path, mPaint);
        }
      } else {
