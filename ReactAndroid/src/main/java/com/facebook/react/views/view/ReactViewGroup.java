...
public class ReactViewGroup extends ViewGroup implements
  ...
  public void addView(View child, int index, ViewGroup.LayoutParams params) {
    ...
    try {
      ...
      FLog.d(ReactConstants.TAG, "ReactViewGroup addView error: " + ex.getMessage());
    }
  ...
  private void addInArray(View child, int index) {
    ...
    if (index == count) {
      ...
      IndexOutOfBoundsException exception =  new IndexOutOfBoundsException("index=" + index + " count=" + count);

      FLog.d(ReactConstants.TAG, "ReactViewGroup addInArray error: " + exception.getMessage());
    }
  }
