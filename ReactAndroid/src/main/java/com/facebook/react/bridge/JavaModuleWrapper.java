...
public class JavaModuleWrapper {
  ...
  public JavaModuleWrapper(JSInstance jsInstance, ModuleHolder moduleHolder, // CRN BEGIN
  ...
  public @Nullable NativeMap getConstants() {
    ...
    try {
      ...
      if (mReactApplicationContext != null) {
        mReactApplicationContext.handleException(new RuntimeException("getConstants error:" + e.getMessage(), e));
      }
      return Arguments.makeNativeMap(new HashMap<String, Object>());
    }
    // CRN END
  }
