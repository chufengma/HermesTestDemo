...
public class CatalystInstanceImpl implements CatalystInstance {
  ...
  public void setCRNModuleIdConfig(HashMap<String, String> moduleIdConfig) {
    ...
    try {
      ...
      FLog.e(ErrorConstants.CRN_FATAL_ERROR, "CatalystInstanceImpl setCRNModuleIdConfig error: " + ex.getMessage());
    }
  }
  ...
  public void setCRNGlobalVariable(String propertyName, String jsonEncodedValue) {
    try {
      ...
      FLog.e(ErrorConstants.CRN_FATAL_ERROR, "CatalystInstanceImpl setCRNGlobalVariable error: " + ex.getMessage());
    }
  }
   ...
   * 是否已经被销毁
   */
  public boolean isCatalystInstanceDestoryed() {
    return mDestroyed;
  }
