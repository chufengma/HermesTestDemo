...
public class ImageEditingManager extends ReactContextBaseJavaModule {
  ...
  @Override
  public void onCatalystInstanceDestroy() { //CRN BEGIN
    try {
      new CleanTask(getReactApplicationContext()).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    } catch (RejectedExecutionException | IllegalStateException ex) {
      FLog.e(ErrorConstants.CRN_FATAL_ERROR, "CatalystInstanceImpl onCatalystInstanceDestroy error: " + ex.getMessage());
    }
    //CRN END
  }
  ...
  private static class CleanTask extends GuardedAsyncTask<Void, Void> {
    ...
    protected void doInBackgroundGuarded(Void... params) {
      ...
      try {
        ...
        FLog.e(ErrorConstants.CRN_FATAL_ERROR, "ImageEditingManager doInBackgroundGuarded error: " + ex.getMessage());
      }
