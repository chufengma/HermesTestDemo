...
public abstract class BaseViewManager<T extends View, C extends LayoutShadowNode>
  ...
  public interface TestIDHooker {
    void onSetTestId(View view, String testId);
  }

  private static TestIDHooker testIDHooker;

  public static void setTestIDHooker(TestIDHooker testIDHooker) {
    BaseViewManager.testIDHooker = testIDHooker;
  }
  ...
  public void setTestId(@Nonnull T view, String testId) {
    ...
    if (testIDHooker != null) {
      testIDHooker.onSetTestId(view, testId);
    }
  }
