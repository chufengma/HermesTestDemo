...
public class UIImplementation {
  ...
  public void setUIRenderEventListener(CRNUIEventListener eventListener, boolean postEventWhenUIChangedFlag) {
    if (mOperationsQueue != null) {
      mOperationsQueue.setUIRenderEventListener(eventListener, postEventWhenUIChangedFlag);
    }
  }
  //CRN END
  ...
  public void onHostDestroy() {
    if (mReactContext != null && mReactContext.clearViewsWhenDestroy()) {
      Log.e("UIImplementation", "need clearViews");
      mOperationsQueue.clearViews();
    }
  }
