  ...
  /*package*/ abstract static class PropSetter {
    ...
    public void updateViewProp(ViewManager viewManager, View viewToUpdate, Object value) {
      try {
        ...
        String errorMessage = new JSApplicationIllegalArgumentException(
            ...
            t).getMessage();
        //CRN BEGIN
        FLog.e(ErrorConstants.CRN_FATAL_ERROR, "ViewManagersPropertyCache$PropSetter_updateViewProp: " + errorMessage);
        //CRN END
      }
    }
